...
# mesh-local2.py
# uses local filepath from builtin.py
...
class Mesh:
    def __init__(
        ...
        all_fields = [self._vertices, self._geodists] # remove  self._faces, self._texcoords
    ...
    # properties can be removed if do not want to check. -- yy similar to getter
    @property
    def vertices(self):
